...
const RSVPForm: React.FC = () => {
  ...
  return (
    <section className="relative z-10 w-full max-w-xl py-5 px-5 xl:px-0 flex flex-col items-center justify-center bg-fondo2 border border-gray-200 rounded-lg mx-4 my-8">
      <form onSubmit={handleSubmit} className="w-full max-w-md p-5">
        ...
        <p className="font-poiretOne text-sm mb-5 text-title text-center">*Evento con adolescentes mayores de 12 años.</p>
        <div className="mb-4">
          <input
            type="text"
            name="name"
